...
int main() {
    int T[] = {4, 67, 80, 9, 1, 45, 78, 76, 3, 60};
    int trie[10];
    int A1[10], A2[10];

    printf("\n--- Construction d'un tas avec methode O(n log n) ---\n");
    construire_tas(T, A1, 10);
    printf("Tas construit : ");
    afficher_tas(A1, 10);

    printf("\nTri du tableau avec methode O(n log n) :\n");
    construire_tab_trie(A1, 10);
    printf("Tableau trie : ");
    afficher_tas(A1, 10);

    printf("\n--- Construction d'un tas avec methode O(n) ---\n");
    construire_tas_n(T, A2, 10);
    printf("Tas construit : ");
    afficher_tas(A2, 10);

    printf("\nTri du tableau avec methode O(n) :\n");
    construire_tab_trie(A2, 10);
    printf("Tableau trie : ");
    afficher_tas(A2, 10);
